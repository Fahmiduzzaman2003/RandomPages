...
const S3 = `abase|He refused to abase himself before a committee he did not respect.~The ritual was designed to abase the newcomer before admitting him.~She would not abase her colleagues to protect her own reputation.
abash|The question abashed him, and he looked at the floor.~She was not abashed by the criticism and continued reading.~Nothing seemed to abash the child, who kept interrupting.
abdicate|The king abdicated in favor of his younger brother.~Critics accused the agency of abdicating its regulatory duties.~By staying silent, the board abdicated its responsibility to shareholders.
abeyance|The project was held in abeyance until funding was restored.~The claim remains in abeyance pending a ruling.~Hostilities were in abeyance for the duration of the harvest.
abhor|She abhors any argument that rests on intimidation.~He abhorred waste of every kind.~The founders abhorred concentrated power and designed against it.
abject|The family lived in abject poverty for a decade.~His abject apology only deepened the embarrassment.~The campaign ended in abject failure.
abjure|The scientist was forced to abjure his findings publicly.~She abjured violence as a means of political change.~He abjured his former allegiances upon taking the post.
abnegate|The order requires members to abnegate personal property.~She abnegated her claim to the estate.~He abnegated all comfort during the year of study.
abolish|The legislature voted to abolish the tax entirely.~Reformers campaigned for decades to abolish the practice.~The new charter abolished the office of governor.
abominate|He abominated cruelty in any form.~She abominates the sentimentality of modern advertising.~The essayist abominated the fashion for false modesty.
abortive|An abortive attempt to seize the capital ended in arrests.~The abortive merger cost both firms millions in fees.~After several abortive drafts, she abandoned the chapter.
abridge|The publisher abridged the novel for classroom use.~The ruling abridges rights the court had previously protected.~He abridged his remarks when he saw the time.
abrogate|The treaty was abrogated within two years of signing.~Parliament moved to abrogate the emergency powers.~No administration may abrogate a right guaranteed by the constitution.
absolve|The inquiry absolved the pilot of any responsibility.~Ignorance does not absolve a company of liability.~She was absolved after the second review of the evidence.
abstain|Three members abstained rather than oppose the chairman.~He abstained from alcohol for the length of the trial.~Voters were urged to abstain rather than spoil their ballots.
abstemious|An abstemious man, he ate one small meal a day.~Her abstemious habits surprised guests at the banquet.~He was abstemious in everything except reading.
abut|The garden abuts the old railway line.~Two properties abut the disputed strip of land.~The new wing abuts the original building awkwardly.
abysmal|The team's abysmal defense cost them the season.~Conditions in the older wards were abysmal.~She described the translation as abysmal.
accede|The government acceded to the strikers' main demand.~He acceded to the throne at nineteen.~The company acceded to an independent audit.
accolade|The award is the highest accolade in the field.~She received accolades from critics who had once dismissed her.~The accolade came thirty years after the work was published.
accost|A stranger accosted him outside the station.~She was accosted by reporters as she left the courthouse.~He disliked being accosted by salesmen in the street.
accretion|The reef grows by slow accretion over centuries.~The doctrine developed by accretion rather than by design.~Sediment accretion gradually closed the harbor.
acme|The novel represents the acme of his career.~She reached the acme of her profession before forty.~The cathedral is the acme of the regional style.
acrid|Acrid smoke filled the corridor.~The wine had an acrid aftertaste.~An acrid smell of burning plastic lingered for days.
acrimonious|The divorce was long and acrimonious.~An acrimonious dispute split the department in two.~Negotiations grew acrimonious after the leak.
adage|The old adage about haste applies here.~She quoted an adage her grandmother used.~The adage is memorable but not always true.
adamant|He was adamant that no exception would be made.~She remained adamant despite considerable pressure.~The committee was adamant about the deadline.
adduce|The prosecution adduced three letters in support.~He adduced no evidence for the sweeping claim.~She adduced examples from four different centuries.
adherent|The movement attracted adherents across the region.~He was a lifelong adherent of the classical school.~Adherents of the theory dismissed the new data.
admonish|The judge admonished the attorney for interrupting.~She admonished her students to check their sources.~He was admonished but not formally disciplined.
adroit|An adroit negotiator, she secured better terms than expected.~His adroit handling of the crisis won praise.~She is adroit at reconciling conflicting accounts.
adulation|The adulation of his fans embarrassed him.~She grew wary of the adulation surrounding her first book.~Public adulation turned to hostility within a year.
adumbrate|The preface adumbrates the argument developed later.~His early essays adumbrate the theory he would publish decades on.~The report adumbrates a policy without committing to it.
advocate|She advocates a phased reduction in emissions.~He advocated for the tenants at every hearing.~The group advocates stricter oversight of the industry.
aesthetic|Her aesthetic sense shaped every detail of the building.~The changes were aesthetic rather than structural.~He judged the design on aesthetic grounds alone.
affable|The affable host made every guest feel expected.~He is affable in person and severe on paper.~Her affable manner disarmed the interviewers.
affectation|His British accent is pure affectation.~She spoke without affectation about the failure.~The affectation of modesty fooled nobody.
affinity|She has an affinity for languages.~There is an affinity between the two composers' late work.~He felt an immediate affinity with the region.
affluent|The school serves an affluent suburb.~Affluent households consumed most of the tax benefit.~He grew up affluent and never quite understood scarcity.
affront|The remark was an affront to everyone present.~She took the omission as a personal affront.~The decision was an affront to established practice.
aggrandize|The reforms served mainly to aggrandize the presidency.~He used the crisis to aggrandize his own department.~The monument was built to aggrandize a mediocre reign.
aggregate|The aggregate of small donations exceeded the single large one.~In the aggregate, the results support the hypothesis.~The report presents an aggregate of twelve regional surveys.
agitate|Students agitated for reform of the admissions system.~The union agitated against the proposed cuts.~News of the closure agitated the whole town.
agnostic|He is agnostic about the existence of a designer.~She described herself as agnostic on the policy question.~An agnostic in matters of faith, he still attended services.
agog|The children were agog at the size of the animal.~The town was agog with rumors of the visit.~She waited agog for the results.
agrarian|The country remained agrarian well into the last century.~Agrarian reform redistributed land to tenant farmers.~The party drew its support from agrarian districts.
alchemy|Some alchemy of timing and luck made the film a hit.~Medieval alchemy laid unexpected groundwork for chemistry.~There is no alchemy that turns weak data into proof.
allege|The complaint alleges systematic overbilling.~She alleged that the records had been altered.~It is alleged, though not established, that he knew.
allegory|The novel is an allegory of the occupation.~The painting works as an allegory of vanity.~He read the story as a political allegory.
alleviate|The grant will alleviate some of the pressure on staff.~Nothing alleviated the pain until the second dose.~The reforms alleviate symptoms without addressing causes.
alliteration|The poem relies on alliteration for its rhythm.~Advertisers favor alliteration because it aids recall.~She avoids alliteration in her prose as too showy.
allocate|The council allocated most of the budget to housing.~Time was allocated equally among the four presenters.~Resources must be allocated where the need is greatest.
allude|He alluded to the scandal without naming anyone.~The title alludes to a passage in Homer.~She alluded to her illness only once.
aloof|He remained aloof from departmental politics.~Her aloof manner was mistaken for arrogance.~The cat stayed aloof from the visitors.
altruism|Pure altruism is rarer than the surveys suggest.~Her altruism extended to strangers she would never meet.~The donation was less altruism than tax planning.
amalgamate|The two firms amalgamated after a decade of rivalry.~Several districts were amalgamated into a single authority.~He amalgamated three traditions into one style.
ambiguous|The wording is ambiguous and invites litigation.~She gave an ambiguous answer and changed the subject.~The evidence is ambiguous enough to support either reading.
amenable|He proved amenable to a compromise.~The material is amenable to precise measurement.~She was amenable to changing the date.
amenity|The building offers few amenities beyond parking.~A public library is an amenity the district lacks.~The hotel advertises amenities it does not provide.
amiable|An amiable discussion followed the formal session.~He is amiable but not especially reliable.~Her amiable nature made her a natural mediator.
amity|The treaty restored amity between the two states.~They parted in amity after years of dispute.~A period of amity followed the settlement.
amorphous|The organization is amorphous and hard to describe.~His plans were amorphous at best.~An amorphous mass of data resisted analysis.
amortize|The loan is amortized over twenty-five years.~The cost of the equipment will be amortized across three seasons.~Development expenses were amortized rather than written off.
analogous|The situation is analogous to the crisis of a decade earlier.~Their functions are analogous though their structures differ.~She drew an analogous case from maritime law.
anarchy|The withdrawal of police left the district in anarchy.~Critics predicted anarchy, but order held.~The play depicts the anarchy that follows the king's death.
anathema|Compromise was anathema to the founders of the movement.~The doctrine was anathema to the established church.~Public subsidy is anathema to his economic views.
ancillary|Ancillary services account for a third of revenue.~The question is ancillary to the main dispute.~She held an ancillary role in the negotiations.
anecdote|He supported the claim with an anecdote rather than data.~The lecture was a string of amusing anecdotes.~An anecdote is not evidence, however vivid.
anguish|The letters record the anguish of the final months.~She spoke of her anguish at the delay.~His face showed real anguish.
animosity|There was open animosity between the two departments.~Years of animosity ended with a brief handshake.~She bore him no animosity despite the ruling.
annex|The empire annexed the province in the following decade.~The city annexed three surrounding townships.~The territory was annexed without a referendum.
annul|The court annulled the contract on procedural grounds.~The election result was annulled after evidence of fraud.~Parliament moved to annul the earlier statute.
anodyne|The statement was anodyne and told us nothing.~He gave an anodyne interview designed to offend no one.~Anodyne background music filled the lobby.
antagonize|He antagonized the very allies he needed.~The policy antagonized farmers across the region.~She was careful not to antagonize the committee.
antediluvian|His views on schooling are frankly antediluvian.~The office ran on antediluvian software.~The rules seem antediluvian to younger staff.
anthology|The anthology collects forty years of her criticism.~He edited an anthology of regional poetry.~The anthology omits several important figures.
antiquated|The factory relied on antiquated machinery.~Antiquated licensing rules slowed every application.~The system is antiquated but stubbornly reliable.
aphorism|The book is a collection of aphorisms on power.~He reduced a complex argument to a memorable aphorism.~Her aphorisms are quoted more often than her essays.
aplomb|She handled the hostile questions with aplomb.~He accepted the criticism with aplomb.~The young pianist performed with surprising aplomb.
apocryphal|The story of the burning manuscript is probably apocryphal.~Several apocryphal quotations are attributed to him.~The anecdote is charming but apocryphal.
apostate|He was branded an apostate by his former colleagues.~The apostate wrote a scathing memoir of the movement.~Apostates were expelled and their names removed.
apotheosis|The concert was the apotheosis of her career.~The building represents the apotheosis of the style.~His apotheosis in official portraits began after his death.
appease|The concessions were intended to appease the protesters.~Nothing would appease the shareholders after the loss.~He tried to appease his critics with a partial retraction.
append|She appended a note explaining the discrepancy.~Three tables are appended to the report.~He appended his signature and dated it.
apposite|The quotation was apposite and closed the argument.~She chose an apposite example from her own fieldwork.~His remarks were brief and apposite.
apprehensive|She was apprehensive about the results.~He grew apprehensive as the deadline approached.~The staff were apprehensive about the reorganization.
appropriate|The state appropriated the land for a highway.~He appropriated the idea without acknowledgment.~Funds were appropriated for flood defenses.
apropos|Her comment was apropos of the earlier discussion.~He said, apropos of nothing, that he was leaving.~The example is apropos and worth pursuing.
aptitude|She showed an early aptitude for mathematics.~The test measures aptitude rather than knowledge.~He has no aptitude for administrative work.
arable|Only a fifth of the land is arable.~Arable acreage has fallen for a decade.~The valley floor is arable; the slopes are not.
arbiter|The committee acts as arbiter in contested cases.~She became the arbiter of taste for a generation.~No single arbiter can settle a question of value.
archaic|The statute uses archaic language that confuses juries.~Archaic spellings survive in a few place names.~The procedure is archaic and rarely invoked.
archetype|He is the archetype of the self-taught engineer.~The story follows a familiar archetype.~The building became an archetype for later civic architecture.
ardor|She pursued the cause with undiminished ardor.~His early ardor for the project cooled quickly.~They defended the proposal with surprising ardor.
arid|The region is arid and depends on imported water.~His prose is arid and hard to finish.~An arid stretch of committee work followed.
arrant|The claim is arrant nonsense.~He dismissed the report as arrant speculation.~It was arrant folly to proceed without permits.
arrogate|The department arrogated powers never granted to it.~He arrogated to himself the right to approve every hire.~The council arrogated authority over local schools.
articulate|She is articulate about problems others cannot name.~He gave an articulate defense of the policy.~The witness was articulate and precise.
artifice|The simplicity of the design is pure artifice.~He won the account through artifice rather than merit.~The novel exposes the artifice of political language.
ascendancy|The faction gained ascendancy after the election.~The theory held ascendancy for thirty years.~Her ascendancy within the firm was rapid.
ascetic|The ascetic lived on bread and water for years.~He adopted an ascetic routine while writing.~Ascetics withdrew to the desert for solitude.
ascribe|Historians ascribe the collapse to several causes.~She ascribed her success to persistence.~The painting is ascribed to a pupil of the master.
asperity|He answered with unusual asperity.~The asperity of her review surprised readers.~There was asperity in his tone throughout.
aspersion|He cast aspersions on her professional competence.~The article casts aspersions without offering evidence.~She resented the aspersions on her motives.
assail|Critics assailed the decision within hours.~He was assailed by doubts on the eve of publication.~The proposal was assailed from both directions.
astute|An astute reader will notice the omission.~She made an astute assessment of the risks.~His astute questions unsettled the panel.
asylum|The family sought asylum after the coup.~The building served as an asylum for the destitute.~Asylum was granted after a two-year review.
atavistic|The crowd's response was atavistic and frightening.~He described the loyalty as atavistic rather than reasoned.~Atavistic traits occasionally reappear in the population.
attenuate|Distance attenuates the signal considerably.~The reforms attenuated the minister's authority.~Time attenuated the bitterness but did not remove it.
augment|She augmented her income with evening teaching.~The collection was augmented by a private bequest.~Additional data augment rather than contradict the finding.
august|The august assembly received the report in silence.~An august figure in the field, he rarely gave interviews.~The august building intimidated first-time visitors.
auspicious|The opening night was auspicious.~It was not an auspicious start to the negotiations.~Auspicious weather favored the launch.
autocrat|The autocrat tolerated no rival institutions.~He ran the department like an autocrat.~The autocrat's reforms outlived his regime.
autonomous|The region became autonomous in all but foreign policy.~Each laboratory operates as an autonomous unit.~She wanted an autonomous role, not a supervised one.
avarice|Avarice, not ambition, drove the scheme.~The novel is a study in avarice.~He warned against the avarice of the new proprietors.
aver|She averred that she had never seen the document.~He avers, without evidence, that the count was wrong.~The witness averred her account was accurate.
averse|He is averse to any change in routine.~She was not averse to a second opinion.~Investors are averse to risk in an uncertain year.
avert|Quick action averted a much larger fire.~The talks averted a strike at the last hour.~She averted her eyes from the screen.
avid|He is an avid collector of early maps.~She was an avid reader from the age of five.~Avid supporters filled the hall.
avuncular|He adopted an avuncular tone with new staff.~His avuncular manner put the students at ease.~The avuncular narrator guides the reader gently.
awry|The plan went awry within the first hour.~Something had gone awry in the calculation.~The schedule went badly awry after the delay.
axiom|The proof rests on three axioms.~It is an axiom of the trade that timing matters most.~She questioned an axiom no one had examined.`;
const S4 = `baleful|He gave the interruption a baleful stare.~A baleful silence settled over the room.~The forecast had a baleful quality that unsettled everyone.
balk|The board balked at the cost of the proposal.~She balked when asked to sign without reading.~Investors balked at the terms and withdrew.
bane|Paperwork was the bane of his working life.~Rust is the bane of every owner of an old car.~Traffic is the bane of the district.
banter|The interview was mostly banter and little substance.~Their banter concealed a genuine rivalry.~He enjoyed the easy banter of the workshop.
bard|The bard recited the poem from memory.~Wandering bards carried the story across the region.~He styled himself a bard of the industrial north.
bastion|The university remained a bastion of the old curriculum.~The court is a bastion of individual rights.~The town was the last bastion of resistance.
beguile|The salesman beguiled her into a longer contract.~The scenery beguiled travelers into staying a week.~He beguiled the hours with card games.
behemoth|The retail behemoth absorbed its last competitor.~A behemoth of a machine occupied the whole floor.~Regulators struggled to oversee the behemoth.
belabor|There is no need to belabor a point everyone accepts.~He belabored the analogy for three paragraphs.~She belabored the issue until the meeting ran over.
beleaguer|The beleaguered minister faced calls to resign.~Beleaguered by debt, the company sold its headquarters.~The beleaguered garrison held out for six weeks.
bellicose|His bellicose speech alarmed the neighboring states.~The tone of the letter was unnecessarily bellicose.~A bellicose faction pushed for immediate action.
belligerent|The belligerent customer refused to leave.~He became belligerent when questioned.~Both belligerent parties agreed to a ceasefire.
bemoan|Critics bemoan the decline of long-form reporting.~He bemoaned the loss of the old market.~She bemoaned her decision for years afterward.
benevolent|The school was founded by a benevolent industrialist.~He took a benevolent interest in his students' careers.~A benevolent policy can still have harsh effects.
bequeath|She bequeathed her library to the college.~The estate was bequeathed to a distant cousin.~He bequeathed his papers to the national archive.
berate|The coach berated the team at halftime.~She berated herself for the oversight.~He was berated in public for a private mistake.
bereft|The town was left bereft of its main employer.~She was bereft after the death of her sister.~The argument is bereft of supporting evidence.
beseech|They beseeched the governor to intervene.~She beseeched him to reconsider.~The letter beseeches the reader to act quickly.
besmirch|The allegations besmirched a long and honorable career.~He would not besmirch a rival to win the seat.~The scandal besmirched the institution for a decade.
bevy|A bevy of consultants descended on the office.~The exhibition attracted a bevy of critics.~A bevy of new regulations followed the collapse.
bias|The study controls for selection bias.~His bias toward familiar authors is obvious.~The survey design introduced an unintended bias.
bibliophile|The bibliophile spent his savings on first editions.~As a bibliophile, she preferred physical books to screens.~The estate was catalogued by a bibliophile.
bilious|He wrote a bilious response to the review.~Her bilious temper cleared as quickly as it came.~The column was bilious and personal.
blandishment|The blandishments of the recruiters had no effect.~She resisted every blandishment offered by the lobbyists.~He won them over with blandishment rather than argument.
blase|She was blase about an award others coveted.~Long experience had made him blase about deadlines.~Their blase reaction surprised the organizers.
blatant|It was a blatant violation of the agreement.~The advertisement contained a blatant falsehood.~He showed blatant disregard for the schedule.
blight|Unemployment was the blight of the region for a generation.~The blight destroyed most of the potato crop.~Vacant lots are a blight on the neighborhood.
blithe|He showed a blithe disregard for the deadline.~Her blithe confidence proved unwarranted.~They were blithe about risks they did not understand.
bombastic|The speech was bombastic and short on detail.~His bombastic style wore thin after a chapter.~The preface is bombastic where the research is careful.
boon|The subsidy proved a boon to small farmers.~Cheap credit was a boon for first-time buyers.~The new bridge is a boon to the whole valley.
boorish|His boorish behavior at dinner offended the hosts.~She would not tolerate boorish remarks from staff.~The critic was boorish rather than merely blunt.
bourgeois|He rejected the bourgeois values of his upbringing.~The novel satirizes bourgeois anxiety about status.~Their tastes were determinedly bourgeois.
brandish|He brandished the report as proof of misconduct.~She brandished a pen at the whiteboard.~The protesters brandished handmade signs.
bravado|His bravado concealed genuine uncertainty.~The announcement was pure bravado.~She entered with a bravado she did not feel.
brazen|It was a brazen attempt to rewrite the record.~He was brazen about the conflict of interest.~The theft was brazen and unhurried.
brevity|The report's brevity is its chief virtue.~She valued brevity in correspondence.~Brevity is difficult; length is easy.
broach|He hesitated before broaching the subject of money.~She broached the possibility of an extension.~Nobody wanted to broach the question of succession.
bulwark|An independent press is a bulwark against abuse.~The dunes act as a bulwark against storm surges.~The charter is a bulwark of local autonomy.
bungle|The department bungled the rollout completely.~He bungled the introduction and lost the room.~A bungled investigation destroyed the case.
buoyant|The market remained buoyant despite the warnings.~She was buoyant after the interview.~Buoyant demand kept the factory running.
burnish|The award burnished an already strong reputation.~He burnished the brass fittings until they gleamed.~The campaign was designed to burnish her image.
buttress|Three studies buttress the central claim.~He buttressed his case with detailed costings.~The wall is buttressed against the slope.
byzantine|The approval process is byzantine and slow.~She navigated the byzantine rules with practiced ease.~A byzantine ownership structure obscured the accounts.`;
...
const CURATED = Object.assign({}, parseSentences(S1), parseSentences(S2), parseSentences(S3), parseSentences(S4));
...
const store = {
  get(k) {
    try {
      ...
      if (v === null) return Promise.reject(new Error("empty"));
...
export default function GreLexicon() {
  ...
  const visible = useMemo(() => {
    ...
    let list = q
      ...
      : BY_LETTER[letter];
    if (filter === "examples") list = list.filter((x) => CURATED[x.w]);
    else if (filter === "new") list = list.filter((x) => !mastery[x.w]);
    else if (filter !== "all") list = list.filter((x) => mastery[x.w] === filter);
    return list;
  }, [query, letter, filter, mastery]);

  const examples = selected ? CURATED[selected.w] || null : null;
  const covered = Object.keys(CURATED).length;

  const pickRandom = () => {
    const withEx = WORDS.filter((x) => CURATED[x.w] && mastery[x.w] !== "known");
    const pool = withEx.length ? withEx : WORDS;
      ...
      <div className="lx-wrap">
        <header style={{ paddingTop: 44 }}>
          ...
          <div className="lx-tools">
            ...
            {[["all", "all"], ["examples", "with sentences"], ["new", "unmarked"], ["learning", "learning"], ["known", "known"]].map(
              ([key, label]) => (
                <button
                  key={key}
                  className="lx-chip"
              ...
              {!selected ? (
                ...
                <>
                  ...
                  {examples ? (
                    ...
                    <p className="lx-empty">
                      Sentences for this word haven't been written yet. The definition
                      above is complete; examples are being added in batches.
                    </p>
                  )}
                  ...
                  {examples && (
                    <div className="lx-note">
                      written and checked by hand · {covered} of {WORDS.length} words done
                    </div>
                  )}
